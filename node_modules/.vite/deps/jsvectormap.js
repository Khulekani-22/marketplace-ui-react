    ...
    !function(t, e) {
      ...
      var _ = function() {
        ...
        return e2.createElement = function(t3) {
          ...
          if (b(t3)) for (var i2 in t3) this.applyAttr(i2, t3[i2]);
      ...
      var G = Object.freeze({ __proto__: null, handleContainerEvents: function() {
        ...
        var t2, e2;
        for (t2 in this.regionLabelsGroup = this.regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths) e2 = new L({ map: this, code: t2, path: this.mapData.paths[t2].path, style: w({}, this.params.regionStyle), labelStyle: this.params.regionLabelStyle, labelsGroup: this.regionLabelsGroup, label: this.params.labels && this.params.labels.regions }), this.regions[t2] = { config: this.mapData.paths[t2], element: e2 };
        ...
        for (var t2 in this.series = { markers: [], regions: [] }, this.params.series) for (var e2 = 0; e2 < this.params.series[t2].length; e2++) this.series[t2][e2] = new I(this.params.series[t2][e2], this[t2], this);
        ...
        function t2(e3) {
          if (void 0 === e3 && (e3 = {}), this.params = x(t2.defaults, e3), !t2.maps[this.params.map]) throw new Error("Attempt to use map which was not loaded: " + e3.map);
        ...
        return e2.init = function(t3) {
          ...
          for (var i2 in B) B[i2] === t3 && y(this.params[i2]) && this.params[i2].apply(this, e3);
